...
// FUNCTIONS TO ADD CUSTOM MENU IN THE DASHBOARD

 add_action( 'admin_menu', 'linked_url' );
    function linked_url() {
    add_menu_page( 'linked_url', 'Add New Video', 'read', '../create_video.html', '', 'dashicons-admin-post', 11 );
//    add_menu_page( 'linked_url', 'Course 2', 'read', '../wp-admin/post.php?post=69&action=edit', '', 'dashicons-admin-post', 12 );
//    add_menu_page( 'linked_url', 'Course 3', 'read', '../wp-admin/post.php?post=76&action=edit', '', 'dashicons-admin-post', 13 );
//    add_menu_page( 'linked_url', 'Recent News', 'read', '../wp-admin/post.php?post=269&action=edit', '', 'dashicons-admin-post', 14 );
//    add_menu_page( 'linked_url', 'Exams', 'read', '../exams-list/', '', 'dashicons-admin-page', 15 );
//    add_menu_page( 'linked_url', 'Videos', 'read', '../videos-list/', '', 'dashicons-admin-page', 16 );
    }
